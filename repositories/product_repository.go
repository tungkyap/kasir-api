// repositories yang memegang kunci untuk mengakses data dari database
// biasanya kita melakukan query di repository sesuai kebutuhan aplikasi
...
func (repo *ProductRepository) GetByID(id int) (*models.Product, error) {
	...
	// TAMBAHKAN $1 setelah tanda sama dengan (=)
	query := "SELECT id, name, price, stock FROM products WHERE id = $1"

	// Masukkan variabel 'id' ke dalam QueryRow
